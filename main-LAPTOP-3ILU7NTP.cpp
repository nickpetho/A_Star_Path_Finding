...
void setProperties() {
     ...
     */
    // 25% chance for a storm to hit
    int stormChance = (rand()%4);
    if(stormChance == 0){
        storm = 1;
        ...
        // 33% chance that 1-4 trees will fall and block certain roads
        ...
        // 50% chance that a flood will cover 2 of the 4 bridges
